...
const FROZEN_DEFAULT_TEXT: Readonly<Record<string, string>> = {
  ...
  "story.chapter1.body.1": "山岸塗装を始める前、山岸信之の一日は、色に始まり、色に終わっていました。持ち場は、家電の量産塗装。工場のラインを流れてくる筐体に、決められた色を、決められた膜厚で、来る日も来る日も吹き付ける。一個目と一万個目が、寸分違わぬ艶であること。それが、その仕事に求められる唯一のことでした。",
  ...
  "story.chapter2.body.2": "「これ、量産品みたいに綺麗に塗れませんか」。知人は言いました。そして、続けた言葉が、山岸の胸に刺さりました。",
  ...
  "story.chapter2.body.3": "その瞬間、山岸は気づきました。塗装はできても3Dプリントの下地を知らない塗装店。造形はできても仕上げは苦手な出力サービス。その二つの**あいだにぽっかり空いた空白**——そこに必要なものは、自分が毎日やっていることそのものだ、と。均一に、正確に、数を美しく塗る。量産塗装の精度こそが、この新しい世界に決定的に欠けているものでした。",
  ...
  "story.chapter5.body.1": "こうして、山岸塗装は始まりました。大分県豊後高田市の、小さな工房。乗用車のバンパーを6本同時に塗れるブースで、あなたの造形物を、量産品の顔に仕上げます。手のひらサイズの小物なら、郵送の送料はごくわずか。地方の工房であることは、もうハンデではありません。",
  ...
  "story.chapter5.body.3": "本当のことを言えば、この物語がどこまで劇的だったかは、大した問題ではありません。大切なのは、いま目の前にある造形物を、どこまで美しく仕上げられるか。その一点だけです。**下地に、誠実に。**——それが、山岸塗装のすべてです。",
  ...
  "story.message.role": "山岸塗装 代表 / 塗装職人",
  "story.message.name": "山岸 信之",
  "story.portrait.initial": "信之",
  "story.portrait.caption": "PORTRAIT — COMING SOON",

  "about.hero.heading": "下地の仕事は、\n見えなくなるからこそ。",
  "about.hero.lead": "仕上がった塗面に、研ぎの跡は残りません。それでも、艶の深さも、色の正確さも、すべては見えなくなった下地が決めています。山岸塗装は、その見えない工程に最も時間を割く工房です。",
  ...
  "about.craftsman.name": "山岸 信之",
  "about.craftsman.romaji": "YAMAGISHI NOBUYUKI — REPRESENTATIVE / PAINTER",
  ...
  "about.profile.table.1.td": "山岸塗装（やまぎしとそう）",
  "about.profile.table.2.th": "代表",
  "about.profile.table.2.td": "山岸 信之",
  "about.profile.table.3.th": "所在地",
  "about.profile.table.3.td": "〒879-0614 大分県豊後高田市来縄3036-1",
  ...
  "about.profile.table.6.td": "「相談する」ページのフォーム／電話 090-9478-5028",
  ...
  "about.location.note": "※ 郵送受託が基本です。ご来訪の際は事前にご連絡ください。",
  ...
  "tokushoho.hero.lead": "通信販売（受託仕上げサービスおよび塗装済み製品の販売）に関する、特定商取引に関する法律第11条に基づく表示です。",
  "tokushoho.spec.seller.th": "販売業者（屋号）",
  "tokushoho.spec.seller.td": "山岸塗装",
  "tokushoho.spec.representative.th": "運営統括責任者",
  "tokushoho.spec.representative.td": "山岸 信之",
  "tokushoho.spec.address.th": "所在地",
  "tokushoho.spec.address.td": "〒879-0614 大分県豊後高田市来縄3036-1",
  "tokushoho.spec.address.note": "※ 郵送でのご依頼を基本としています。ご来訪の際は事前にご連絡ください。",
  "tokushoho.spec.tel.th": "電話番号",
  "tokushoho.spec.tel.td": "090-9478-5028",
  "tokushoho.spec.tel.note": "※ 作業中は電話に出られない場合があります。「相談する」ページの窓口もご利用ください。",
  "tokushoho.spec.contact.th": "お問い合わせ窓口",
  "tokushoho.spec.contact.td": "「相談する」ページのお問い合わせフォーム、または電話（090-9478-5028）",
  ...
  "tokushoho.mapnote": "最終更新：2026年9月",

  "privacy.hero.index": "LEGAL",
  "privacy.hero.en": "PRIVACY POLICY",
  "privacy.hero.title": "プライバシーポリシー",
  "privacy.hero.lead": "山岸塗装(以下「当工房」といいます)は、お問い合わせ・お見積もり・施工のご依頼にあたってお預かりする個人情報を、以下の方針に基づき適切に取り扱います。",
  "privacy.spec.business.th": "1. 事業者情報",
  "privacy.spec.business.td": "屋号：山岸塗装(やまぎしとそう)\n代表者：山岸 信之\n所在地：〒879-0614 大分県豊後高田市来縄3036-1",
  "privacy.spec.business.note": "※ 電話番号：090-9478-5028。お問い合わせは「相談する」ページの窓口でも承ります。",
