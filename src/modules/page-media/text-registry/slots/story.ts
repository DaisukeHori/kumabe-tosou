...
export const STORY_TEXT_SLOTS: readonly PageTextSlot[] = [
  ...
  },
  {
    ...
    maxLen: 170,
    defaultText:
      "山岸塗装を始める前、山岸信之の一日は、色に始まり、色に終わっていました。持ち場は、家電の量産塗装。工場のラインを流れてくる筐体に、決められた色を、決められた膜厚で、来る日も来る日も吹き付ける。一個目と一万個目が、寸分違わぬ艶であること。それが、その仕事に求められる唯一のことでした。",
  },
  {
  ...
  },
  {
    ...
    maxLen: 70,
    defaultText:
      "「これ、量産品みたいに綺麗に塗れませんか」。知人は言いました。そして、続けた言葉が、山岸の胸に刺さりました。",
  },
  {
  ...
  },
  {
    ...
    maxLen: 195,
    defaultText:
      "その瞬間、山岸は気づきました。塗装はできても3Dプリントの下地を知らない塗装店。造形はできても仕上げは苦手な出力サービス。その二つの**あいだにぽっかり空いた空白**——そこに必要なものは、自分が毎日やっていることそのものだ、と。均一に、正確に、数を美しく塗る。量産塗装の精度こそが、この新しい世界に決定的に欠けているものでした。",
  },
  ...
  },
  {
    ...
    maxLen: 155,
    defaultText:
      "こうして、山岸塗装は始まりました。大分県豊後高田市の、小さな工房。乗用車のバンパーを6本同時に塗れるブースで、あなたの造形物を、量産品の顔に仕上げます。手のひらサイズの小物なら、郵送の送料はごくわずか。地方の工房であることは、もうハンデではありません。",
  },
  {
  ...
  },
  {
    ...
    maxLen: 140,
    defaultText:
      "本当のことを言えば、この物語がどこまで劇的だったかは、大した問題ではありません。大切なのは、いま目の前にある造形物を、どこまで美しく仕上げられるか。その一点だけです。**下地に、誠実に。**——それが、山岸塗装のすべてです。",
  },
