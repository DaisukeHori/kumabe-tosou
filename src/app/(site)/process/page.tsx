...
export const metadata: Metadata = {
  title: {
    absolute: "工程 | 山岸塗装 — 一個が仕上がるまでの、9つの手",
  },
  description:
    "3Dプリント造形物が量産品の外観になるまで。積層痕の研磨、洗浄・脱脂、プラサフ、足付け水研ぎ、ベースコート、クリアコート、常温硬化、検品——自動車補修の工程を、塗膜の層構造とともに一手ずつ解説します。山岸塗装の全工程。",
  openGraph: {
    title: "工程 | 山岸塗装 — 一個が仕上がるまでの、9つの手",
    description:
