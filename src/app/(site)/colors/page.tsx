...
export const metadata: Metadata = {
  title: {
    absolute: "色見本 | 山岸塗装 — 名車の象徴色で組んだ8枚の技術証明",
  },
  description:
    "山岸塗装のカラーラインナップ。トヨタ090ホワイトパール、マツダ46Vソウルレッド、日産TV2ベイサイドブルーほか、名車の象徴色8色。8色中5色が3コート・高難度系です。",
  openGraph: {
    title: "色見本 | 山岸塗装 — 名車の象徴色で組んだ8枚の技術証明",
    description:
