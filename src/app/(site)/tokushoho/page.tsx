...
export const metadata: Metadata = {
  title: {
    absolute: "特定商取引法に基づく表記 | 山岸塗装",
  },
  description:
    "山岸塗装の特定商取引法に基づく表記。販売業者、取引条件（価格・支払方法・引渡時期・返品条件）、送料などについて記載しています。",
  robots: {
    index: false,
  },
  openGraph: {
    title: "特定商取引法に基づく表記 | 山岸塗装",
    description:
      "山岸塗装の特定商取引法に基づく表記。販売業者、取引条件、送料などについて記載しています。",
    images: ["/hero.jpg"],
  },
};
