...
export const metadata: Metadata = {
  title: {
    absolute: "ストーリー | 山岸塗装 — なぜ、積層痕と戦うことにしたのか",
  },
  description:
    "家電の量産塗装職人が、なぜ3Dプリントの表面処理専門工房を始めたのか。一本の相談から、積層痕との出会い、樹脂との格闘、そして「量産品と見分けがつかない」への到達まで。山岸塗装のストーリーと、代表・山岸信之からのメッセージ。",
  openGraph: {
    title: "ストーリー | 山岸塗装 — なぜ、積層痕と戦うことにしたのか",
    description:
