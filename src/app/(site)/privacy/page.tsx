...
export const metadata: Metadata = {
  title: {
    absolute: "プライバシーポリシー | 山岸塗装",
  },
  description:
    "山岸塗装のプライバシーポリシー。取得する個人情報、利用目的、第三者提供、保存期間、開示・訂正・削除の請求方法、Cookieの利用について記載しています。",
  openGraph: {
    title: "プライバシーポリシー | 山岸塗装",
    description:
      "山岸塗装のプライバシーポリシー。取得する個人情報、利用目的、第三者提供、保存期間、開示・訂正・削除の請求方法について。",
    images: ["/hero.jpg"],
  },
};
