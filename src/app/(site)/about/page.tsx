...
export const metadata: Metadata = {
  title: {
    absolute: "会社案内 | 山岸塗装 — 3Dプリント表面処理の専門工房",
  },
  description:
    "山岸塗装の会社案内。代表・山岸信之のプロフィール、工房設備、会社概要、所在地（大分県豊後高田市）。家電量産塗装で培った精度を、3Dプリントの表面処理に注ぐ自動車塗装職人の工房です。",
  openGraph: {
    title: "会社案内 | 山岸塗装 — 3Dプリント表面処理の専門工房",
    description:
      "代表・山岸信之のプロフィール、工房設備、会社概要、所在地（大分県豊後高田市）。",
