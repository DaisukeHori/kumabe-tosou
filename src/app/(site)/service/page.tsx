...
export const metadata: Metadata = {
  title: {
    absolute: "サービス・料金 | 山岸塗装 — 工程・グレード・依頼の流れ",
  },
  description:
    "山岸塗装のサービスと料金。#800研磨→プラサフ→#1200水研ぎの共通下地に、下地仕上げ・スタンダード・プレミアム（3コートパール）の3グレード。数量スライド、依頼の流れ、正直な条件まで。",
  openGraph: {
    title: "サービス・料金 | 山岸塗装 — 工程・グレード・依頼の流れ",
    description:
